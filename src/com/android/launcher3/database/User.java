...
public class User {
    ...
    public User(Long id, String packageName, long date, boolean wifiConnect,
            ...
            boolean inWorkspace, boolean isMonday, boolean isThesday,
            boolean isWednesday, boolean isThursday, boolean isFriday,
            boolean isSaturday, boolean isSunday, boolean isJanuary,
            boolean isFebruary, boolean isMarch, boolean isApril, boolean isMay,
            boolean isJune, boolean isJuly, boolean isAugust, boolean isSeptember,
