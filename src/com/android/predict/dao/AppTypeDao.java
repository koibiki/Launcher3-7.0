...
public class AppTypeDao extends AbstractDao<AppType, Long> {
    ...
    public static class Properties {
        ...
        public final static Property AppType = new Property(2, int.class, "appType", false, "APPTYPE");
        public final static Property IsBrowser = new Property(3, boolean.class, "isBrowser", false, "ISBROWSER");
        public final static Property IsEfficiency = new Property(4, boolean.class, "isEfficiency", false, "ISEFFICIENCY");
        public final static Property IsGame = new Property(5, boolean.class, "isGame", false, "ISGAME");
        public final static Property IsIm = new Property(6, boolean.class, "isIm", false, "ISIM");
        public final static Property IsMedia = new Property(7, boolean.class, "isMedia", false, "ISMEDIA");
        public final static Property IsPay = new Property(8, boolean.class, "isPay", false, "ISPAY");
        public final static Property IsRead = new Property(9, boolean.class, "isRead", false, "ISREAD");
        public final static Property IsShop = new Property(10, boolean.class, "isShop", false, "ISSHOP");
        public final static Property IsSport = new Property(11, boolean.class, "isSport", false, "ISSPORT");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"APP_TYPE\" (" + //
                ...
                "\"ISEFFICIENCY\" INTEGER NOT NULL ," + // 4: isEfficiency
                "\"ISGAME\" INTEGER NOT NULL ," + // 5: isGame
                "\"ISIM\" INTEGER NOT NULL ," + // 6: isIm
                "\"ISMEDIA\" INTEGER NOT NULL ," + // 7: isMedia
                "\"ISPAY\" INTEGER NOT NULL ," + // 8: isPay
                "\"ISREAD\" INTEGER NOT NULL ," + // 9: isRead
                "\"ISSHOP\" INTEGER NOT NULL ," + // 10: isShop
    ...
    protected final void bindValues(DatabaseStatement stmt, AppType entity) {
        ...
        stmt.bindLong(4, entity.getIsBrowser() ? 1L: 0L);
        stmt.bindLong(5, entity.getIsEfficiency() ? 1L: 0L);
        stmt.bindLong(6, entity.getIsGame() ? 1L: 0L);
        stmt.bindLong(7, entity.getIsIm() ? 1L: 0L);
        stmt.bindLong(8, entity.getIsMedia() ? 1L: 0L);
        stmt.bindLong(9, entity.getIsPay() ? 1L: 0L);
        stmt.bindLong(10, entity.getIsRead() ? 1L: 0L);
        stmt.bindLong(11, entity.getIsShop() ? 1L: 0L);
        stmt.bindLong(12, entity.getIsSport() ? 1L: 0L);
    ...
    public AppType readEntity(Cursor cursor, int offset) {
        AppType entity = new AppType( //
            ...
            cursor.getShort(offset + 3) != 0, // isBrowser
            cursor.getShort(offset + 4) != 0, // isEfficiency
            cursor.getShort(offset + 5) != 0, // isGame
            cursor.getShort(offset + 6) != 0, // isIm
            cursor.getShort(offset + 7) != 0, // isMedia
            cursor.getShort(offset + 8) != 0, // isPay
            cursor.getShort(offset + 9) != 0, // isRead
            cursor.getShort(offset + 10) != 0, // isShop
    ...
    public void readEntity(Cursor cursor, AppType entity, int offset) {
        ...
        entity.setIsBrowser(cursor.getShort(offset + 3) != 0);
        entity.setIsEfficiency(cursor.getShort(offset + 4) != 0);
        entity.setIsGame(cursor.getShort(offset + 5) != 0);
        entity.setIsIm(cursor.getShort(offset + 6) != 0);
        entity.setIsMedia(cursor.getShort(offset + 7) != 0);
        entity.setIsPay(cursor.getShort(offset + 8) != 0);
        entity.setIsRead(cursor.getShort(offset + 9) != 0);
        entity.setIsShop(cursor.getShort(offset + 10) != 0);
        entity.setIsSport(cursor.getShort(offset + 11) != 0);
